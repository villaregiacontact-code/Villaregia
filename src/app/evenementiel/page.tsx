      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-6 space-y-6">
            <div className="relative w-full h-[400px] rounded-xs overflow-hidden bg-[#FAF8F3] border border-[rgba(19,35,57,0.14)] shadow-xl">
              <Image
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#132339]/80 via-transparent to-transparent" />
              <div className="absolute bottom-6 left-6 right-6 text-[#FAF8F3]">
                <span className="text-[10px] font-semibold uppercase text-[#B8912E] block tracking-wider">Domaine Palm Grove Sfax</span>
                <h3 className="font-serif text-2xl font-semibold">Capacité jusqu'à 450 invités</h3>
              </div>
            </div>

            <div className="space-y-4">
              <h3 className="font-serif text-2xl font-semibold text-[#132339]">Prestations Incluses</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  ...
                  <div key={idx} className="flex items-center gap-2.5 p-3 rounded-xs bg-[#FAF8F3] border border-[rgba(19,35,57,0.14)] text-xs text-[#132339] font-medium shadow-2xs">
                    <CheckCircle className="w-4 h-4 text-[#6E7A52] shrink-0" />
                    <span>{item}</span>
                  </div>
                ))}
              </div>
          ...
          <div className="lg:col-span-6">
            <div className="bg-[#FAF8F3] p-8 rounded-xs border border-[rgba(19,35,57,0.14)] shadow-xl space-y-6">
              
              <div className="border-b border-[rgba(19,35,57,0.1)] pb-4">
                <span className="text-xs font-semibold uppercase text-[#6E7A52]">Formulaire de Devis Sur Mesure</span>
              ...
              {submitted ? (
                <div className="text-center py-12 space-y-4">
                  ...
                  <h4 className="font-serif text-2xl font-semibold text-[#132339]">Demande Transmise</h4>
                  ...
                  <button
                    ...
                    className="bg-[#B15A3C] text-[#FAF8F3] px-6 py-2.5 rounded-xs text-xs font-semibold uppercase tracking-wider"
                  >
                    Nouvelle Demande
                  </button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    <label className="text-[10px] font-semibold uppercase text-[#6E7A52] block mb-1">Type d’événement</label>
                    <select
                      value={eventType}
                      onChange={(e) => setEventType(e.target.value)}
                      className="w-full bg-[#FAF8F3] border border-[rgba(19,35,57,0.18)] rounded-xs px-3.5 py-2.5 text-xs text-[#132339] font-medium"
                    >
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="text-[10px] font-semibold uppercase text-[#6E7A52] block mb-1">Nombre d’invités</label>
                      <input
                        type="number"
                        value={guestCount}
                        onChange={(e) => setGuestCount(Number(e.target.value))}
                        className="w-full bg-[#FAF8F3] border border-[rgba(19,35,57,0.18)] rounded-xs px-3.5 py-2.5 text-xs text-[#132339]"
                      />
                    </div>
                    <div>
                      <label className="text-[10px] font-semibold uppercase text-[#6E7A52] block mb-1">Date souhaitée</label>
                      <input
                        type="date"
                        value={eventDate}
                  ...
                  <div>
                    <label className="text-[10px] font-semibold uppercase text-[#6E7A52] block mb-1">Nom complet</label>
                    <input
                      required
                      type="text"
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="text-[10px] font-semibold uppercase text-[#6E7A52] block mb-1">Téléphone</label>
                      <input
                        required
                        type="tel"
                    ...
                    <div>
                      <label className="text-[10px] font-semibold uppercase text-[#6E7A52] block mb-1">Email</label>
                      <input
                        required
                        type="email"
                  ...
                  <div>
                    <label className="text-[10px] font-semibold uppercase text-[#6E7A52] block mb-1">Précisions ou demandes particulières</label>
                    <textarea
                      rows={3}
                  ...
                  <button
                    type="submit"
                    className="w-full bg-[#B15A3C] hover:bg-[#97492e] text-[#FAF8F3] font-semibold text-xs uppercase tracking-wider py-3.5 rounded-xs shadow-md transition-all flex items-center justify-center gap-2"
                  >
