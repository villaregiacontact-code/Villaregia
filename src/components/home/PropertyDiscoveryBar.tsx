...
export const PropertyDiscoveryBar: React.FC = () => {
  ...
  return (
    <div className="relative z-20 max-w-6xl mx-auto -mt-12 px-4 sm:px-6">
      <div className="bg-[#FAF8F3] rounded-xl p-6 shadow-2xl border border-[rgba(26,22,21,0.14)] text-[#1A1615]">
        
        {/* Universe Selector Tabs */}
        <div className="flex flex-wrap gap-2 mb-6 border-b border-[rgba(26,22,21,0.12)] pb-4">
          <span className="text-xs uppercase tracking-widest text-[#443E3B] font-semibold self-center mr-2 rtl:ml-2">
            {t('search.title')}
          </span>
            ...
            <button
              ...
              className={`px-3.5 py-1.5 rounded text-xs font-semibold uppercase tracking-wider transition-all ${
                universe === u
                  ...
                  : 'bg-[#EFE8D8] text-[#443E3B] hover:bg-[#1A1615] hover:text-[#FAF8F3]'
              }`}
            >
              {u === 'ALL'
        ...
        <form onSubmit={handleSearch} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full bg-white border border-[rgba(26,22,21,0.18)] rounded px-3.5 py-2.5 text-xs text-[#1A1615] placeholder-[#443E3B]/50 focus:outline-none focus:border-[#B15A3C] transition-colors"
            />
          </div>
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              className="w-full bg-white border border-[rgba(26,22,21,0.18)] rounded px-3.5 py-2.5 text-xs text-[#1A1615] focus:outline-none focus:border-[#B15A3C] transition-colors font-medium"
            >
          ...
          <div className="space-y-1">
            ...
            <div className="w-full bg-[#EFE8D8] border border-[rgba(26,22,21,0.14)] rounded px-3.5 py-2.5 text-xs text-[#1A1615] font-medium flex items-center justify-between">
              <span>
                {universe === 'VENTE'
                  ? 'Patrimoine Foncier'
                  : universe === 'LUXE'
