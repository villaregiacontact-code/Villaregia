    ...
    <section className="py-20 sm:py-24 bg-[#FAF8F3] overflow-hidden">
      <div className="max-w-[1180px] mx-auto px-4 sm:px-8 grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-12 sm:gap-16 items-center">
        ...
        >
          ...
          <h2 className="font-serif text-3xl sm:text-4xl text-[#1A1615] font-semibold max-w-[14ch] leading-tight">
            Le décor de votre prochain grand jour.
          </h2>
          <p className="mt-4 text-base text-[#443E3B] max-w-[42ch] leading-relaxed">
          ...
          <div className="mt-7 flex flex-wrap gap-2.5">
            {[
              ...
              <span key={chip} className="border border-[rgba(26,22,21,0.14)] px-3.5 py-2 text-xs sm:text-sm text-[#1A1615] rounded-xs font-medium bg-[#FAF8F3]/80 hover:bg-[#1A1615] hover:text-[#FAF8F3] transition-colors cursor-default">
                {chip}
              </span>
            ))}
          </div>
        ...
        >
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#1A1615]/60 via-transparent to-black/10" />
          <div className="absolute inset-[14px] border border-white/30 rounded-[390px_390px_12px_12px] pointer-events-none" />

          {/* Floating Badge */}
          <div className="absolute bottom-6 left-6 right-6 bg-[#1A1615]/80 backdrop-blur-md border border-[#B8912E]/30 p-4 rounded-xs text-[#FAF8F3]">
