...
export const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({
  ...
  const phone = '21627745403'; // Villa Regia Sfax official WhatsApp Business contact
  ...
  return (
    <a
      ...
      aria-label="Contacter Villa Regia sur WhatsApp Business (+216 27 745 403)"
      title="Compte WhatsApp Business Officiel — Villa Regia (+216 27 745 403)"
    >
